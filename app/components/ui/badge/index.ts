  ...
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 select-none',
  {
    variants: {
      variant: {
        ...
        violet: 'bg-violet-600 text-white hover:bg-violet-600/80 dark:bg-violet-400 dark:text-black dark:hover:bg-violet-400/80 ',
        slate: 'bg-slate-600 text-white hover:bg-slate-600/80 dark:bg-slate-400 dark:text-black dark:hover:bg-slate-400/80',
        ...
        neutral: 'bg-neutral-600 text-white hover:bg-neutral-600/80 dark:bg-neutral-400 dark:text-black dark:hover:bg-neutral-400/80',
        stone: 'bg-stone-600 text-white hover:bg-stone-600/80 dark:bg-stone-400 dark:text-black dark:hover:bg-stone-400/80',
        ...
        amber: 'bg-amber-600 text-white hover:bg-amber-600/80 dark:bg-amber-400 dark:text-black dark:hover:bg-amber-400/80',
        yellow: 'bg-yellow-600 text-white hover:bg-yellow-600/80 dark:bg-yellow-400 dark:text-black dark:hover:bg-yellow-400/80',
        lime: 'bg-lime-600 text-white hover:bg-lime-600/80 dark:bg-lime-400 dark:text-black dark:hover:bg-lime-400/80',
        green: 'bg-green-600 text-white hover:bg-green-600/80 dark:bg-green-400 dark:text-black dark:hover:bg-green-400/80',
        emerald: 'bg-emerald-600 text-white hover:bg-emerald-600/80 dark:bg-emerald-400 dark:text-black dark:hover:bg-emerald-400/80',
        ...
        indigo: 'bg-indigo-600 text-white hover:bg-indigo-600/80 dark:bg-indigo-400 dark:text-black dark:hover:bg-indigo-400/80',
        purple: 'bg-purple-600 text-white hover:bg-purple-600/80 dark:bg-purple-400 dark:text-black dark:hover:bg-purple-400/80',
        fuchsia: 'bg-fuchsia-600 text-white hover:bg-fuchsia-600/80 dark:bg-fuchsia-400 dark:text-black dark:hover:bg-fuchsia-400/80',
